...
public class CustomItemAnimator extends SimpleItemAnimator {
   ...
   /* @Override
    ...
    void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        final ViewPropertyAnimatorCompat animation = ViewCompat.animate(view);
        //animation.rotationXBy(180); // TODO: 2017/5/18  
        ...
        animation.setDuration(getMoveDuration()).setListener(new VpaListenerAdapter() {
            ...
            public void onAnimationEnd(View view) {
                animation.setListener(null);
                //ViewCompat.setRotationX(view,0); // TODO: 2017/5/18
                dispatchMoveFinished(holder);
    ...
    public void endAnimation(ViewHolder item) {
        ...
        if (mRemoveAnimations.remove(item) && DEBUG) {
            throw new IllegalStateException("after animation is cancelled, item_app_manager should not be in "
